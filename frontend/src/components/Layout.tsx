...
import { LayoutDashboard, List, Database, Settings as SettingsIcon, PanelLeftClose, PanelLeftOpen, BarChart3 } from 'lucide-react';
...
export function AppSidebar() {
  ...
  return (
    <Sidebar variant="sidebar" collapsible={collapsed ? "icon" : "offcanvas"} className="border-r h-screen flex flex-col">
