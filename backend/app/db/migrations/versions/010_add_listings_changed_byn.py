...
def upgrade() -> None:
    ...
    op.add_column('scan_history', sa.Column('listings_changed_byn', sa.Integer(), nullable=True, default=0))
    # Set default value for existing records
    op.execute("UPDATE scan_history SET listings_changed_byn = 0 WHERE listings_changed_byn IS NULL")
