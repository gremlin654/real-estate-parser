    ...
    **Логирование:**
    ...
    try:
        ...
        for listing in listings:
            ...
            price_per_m2 = (
                float(listing.price_per_m2_byn) if currency.lower() == "byn"
...
async def get_deals_stats(
    ...
    """
    logger.info(f"Deal Finder stats request: city={city}, rooms={rooms}, currency={currency}")
    ...
    try:
        ...
        price_col = (
            Listing.price_per_m2_byn if currency.lower() == "byn"
