...
async def _set_to_cache(
    redis_client: redis.Redis, key: str, data: Any, ttl: int
) -> bool:
    """
...
async def _invalidate_cache_pattern(redis_client: redis.Redis, pattern: str) -> int:
    """
...
def cache_response(
    prefix: str = "cache", ttl: int = 60, key_params: Optional[List[str]] = None
) -> Callable:
    """
    Decorator для кэширования ответов API в Redis.
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.warning(
                    f"Redis not available, skipping cache for {func.__name__}: {e}"
                )
            ...
            if request and hasattr(request, "query_params"):
                ...
                params = {
                    ...
                    if k not in ["db", "request", "skip", "limit"] and v is not None
                }
