...
class Settings(BaseSettings):
    ...
    RATE_LIMIT_REFILL_RATE: float = 2.0    # Токенов в секунду на город (медленнее чтобы не блокировали)
    RATE_LIMIT_TTL: int = 3600             # TTL ключей (1 час)
    RATE_LIMIT_REQUESTS_PER_SECOND: int = 2  # На каждый город (осторожно при 6 городах = 12/sec total)
